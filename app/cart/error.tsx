...
import { ShoppingBag, RefreshCcw, Home } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4 pt-24">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
        <div className="w-16 h-16 bg-[#FCEEF2] rounded-full flex items-center justify-center mx-auto mb-6">
          <ShoppingBag className="w-8 h-8 text-[#E06B8B]" strokeWidth={1.5} />
        </div>
        <h1 className="text-xl font-bold text-gray-900 mb-2">Сагс ачааллахад алдаа гарлаа</h1>
        <p className="text-gray-600 text-sm mb-6">
          Дахин оролдоно уу эсвэл нүүр хуудас руу буцна уу.
        </p>
